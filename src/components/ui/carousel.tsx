...
const CarouselPrevious = forwardRef<HTMLButtonElement, Parameters<typeof Button>[0]>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
...
const CarouselNext = forwardRef<HTMLButtonElement, Parameters<typeof Button>[0]>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
