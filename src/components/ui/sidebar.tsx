...
const SidebarTrigger = forwardRef<React.ElementRef<typeof Button>, ComponentProps<typeof Button>>(
...
const SidebarInput = forwardRef<React.ElementRef<typeof Input>, ComponentProps<typeof Input>>(({ className, ...props }, ref) => (
  <Input
    ref={ref}
    data-sidebar="input"
...
const SidebarSeparator = forwardRef<React.ElementRef<typeof Separator>, ComponentProps<typeof Separator>>(
  ({ className, ...props }, ref) => (
...
>(({ asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, ...props }, ref) => {
  ...
  const resolvedTooltip: ComponentProps<typeof TooltipContent> =
    typeof tooltip === "string" ? { children: tooltip } : tooltip;

  return (
    <Tooltip>
      <TooltipTrigger asChild>{button}</TooltipTrigger>
      <TooltipContent side="right" align="center" hidden={state !== "collapsed" || isMobile} {...resolvedTooltip} />
    </Tooltip>
  );
});
